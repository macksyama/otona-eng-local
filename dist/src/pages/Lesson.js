...
// ユーザーアイコン（user.png画像）
const UserIcon = ((0, jsx_runtime_1.jsx)("img", { src: "./user.png", alt: "User", className: "w-10 h-10 rounded-full object-cover border border-gray-300 bg-white", draggable: false }));
// AIリクエスト共通関数
...
const Lesson = ({ article, setPage, setSummaryData }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col h-screen", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-auto p-4 border-b bg-white", children: [(0, jsx_runtime_1.jsx)("h2", { className: "font-bold mb-2", children: "\u5165\u529B\u8A18\u4E8B" }), (0, jsx_runtime_1.jsx)("div", { className: "whitespace-pre-wrap text-gray-800", children: article })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-auto p-4 bg-gray-100 flex flex-col", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-y-auto mb-2", children: [chat.map((msg, i) => ((0, jsx_runtime_1.jsxs)("div", { className: "mb-2", children: [msg.role === 'ai' && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-start", children: [(0, jsx_runtime_1.jsx)("div", { className: "mr-2 flex-shrink-0", children: TeacherIcon }), (0, jsx_runtime_1.jsxs)("div", { className: "bg-white rounded-lg px-4 py-2 shadow text-blue-700 font-bold max-w-[70%]", children: ["AI: ", msg.text] })] })), msg.role === 'user' && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-start justify-end", children: [(0, jsx_runtime_1.jsxs)("div", { className: "bg-blue-600 text-white rounded-lg px-4 py-2 shadow max-w-[70%] text-right", children: ["\u3042\u306A\u305F: ", msg.text] }), (0, jsx_runtime_1.jsx)("div", { className: "ml-2 flex-shrink-0", children: UserIcon })] })), msg.role === 'ai-feedback' && ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-start", children: [(0, jsx_runtime_1.jsx)("div", { className: "mr-2 flex-shrink-0", children: TeacherIcon }), (0, jsx_runtime_1.jsx)("div", { className: "bg-green-50 rounded-lg px-4 py-2 shadow text-green-700 max-w-[70%]", children: typeof msg.score === 'number' && (msg.modelAnswer !== undefined || msg.mistakes !== undefined || msg.correction !== undefined || msg.advice !== undefined) && !msg.text?.startsWith('AI応答の解析に失敗しました') ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("b", { children: "\u30B9\u30B3\u30A2:" }), " ", msg.score, "\u70B9"] }), (msg.mistakes ?? '') !== '' && (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("b", { children: "\u9593\u9055\u3044:" }), " ", msg.mistakes] }), (msg.correction ?? '') !== '' && (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("b", { children: "\u4FEE\u6B63\u4F8B:" }), " ", msg.correction] }), (msg.advice ?? '') !== '' && (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("b", { children: "\u30A2\u30C9\u30D0\u30A4\u30B9:" }), " ", msg.advice] }), (msg.modelAnswer ?? '') !== '' && (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("b", { children: "\u6A21\u7BC4\u89E3\u7B54:" }), " ", msg.modelAnswer] })] })) : ((0, jsx_runtime_1.jsxs)("div", { children: ["AI\u8A55\u4FA1: ", msg.text, " ", (0, jsx_runtime_1.jsxs)("span", { className: "ml-2 font-bold", children: ["+", msg.score, "\u70B9"] })] })) })] }))] }, i))), error && (0, jsx_runtime_1.jsx)("div", { className: "text-red-600 whitespace-pre-wrap", children: error })] }), !showResult && currentQuestion && ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col", children: [!(currentQuestion.type === 'discussion' && discussionSubStep === 2) && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("textarea", { className: "w-full h-24 p-2 border rounded mb-2", value: input, onChange: e => setInput(e.target.value), placeholder: "\u3042\u306A\u305F\u306E\u56DE\u7B54\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044", disabled: loading }), (0, jsx_runtime_1.jsx)("button", { className: "bg-blue-600 text-white px-4 py-2 rounded self-end disabled:opacity-50", onClick: handleSend, disabled: !input.trim() || loading || !currentQuestion || !currentQuestion.text, children: loading ? '送信中...' : '回答送信' })] })), (0, jsx_runtime_1.jsxs)("div", { className: "mt-2 text-sm text-gray-500", children: [step + 1, " / ", totalQuestions, " \u554F"] }), currentQuestion.type === 'discussion' && discussionSubStep === 2 && ((0, jsx_runtime_1.jsx)("button", { className: "mt-4 px-4 py-2 bg-green-600 text-white rounded", onClick: handleSummary, disabled: summaryLoading, children: summaryLoading ? 'サマリー生成中...' : 'Summary' }))] }))] })] }));
};
