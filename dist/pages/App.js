...
const App = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "min-h-screen bg-gray-50 relative", children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => setPage('settings'), style: { position: 'absolute', top: 16, right: 24, background: 'none', border: 'none', cursor: 'pointer' }, "aria-label": "\u8A2D\u5B9A", children: GearIcon }), page === 'settings' ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Settings_1.default, {}), (0, jsx_runtime_1.jsx)("button", { onClick: () => setPage('home'), style: { position: 'absolute', top: 16, left: 24, background: 'none', border: 'none', cursor: 'pointer', fontSize: 18 }, children: "\u2190 \u623B\u308B" })] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [page === 'home' && (0, jsx_runtime_1.jsx)(Home_1.default, { setPage: setPage, setArticle: setArticle }), page === 'lesson' && (0, jsx_runtime_1.jsx)(Lesson_1.default, { article: article, setPage: setPage, setSummaryData: setSummaryData }), page === 'summary' && (0, jsx_runtime_1.jsx)(Summary_1.default, { setPage: setPage, summaryData: summaryData })] }))] }));
};
exports.default = App;
